...
namespace Domain.Entidades
{
    public class Mensagem
    {
        ...
        public Mensagem(IEnumerable<Destinatario> destinatarios, string assunto, Guid usuarioId, string username, string codigoAtivacao, string pageTitle, string baseUrl, string email = "")
        {
